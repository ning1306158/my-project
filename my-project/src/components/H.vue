<template>
	<div class="hello">
		...
		<el-table :data="tableData" class="tb-edit" highlight-current-row @row-click="handleCurrentChange">
			...
			<el-table-column prop="address" label="红色需" width="100"> <template scope="scope"> <span>{{scope.row.skill.red}}</span>
				</template> </el-table-column>
			<el-table-column prop="address" label="绿色需" width="100"> <template scope="scope"> <span>{{scope.row.skill.green}}</span>
				</template> </el-table-column>
			<el-table-column prop="address" label="蓝色需" width="100"> <template scope="scope"> <span>{{scope.row.skill.blue}}</span>
				</template> </el-table-column>
			<el-table-column prop="address" label="黄色需" width="100"> <template scope="scope"> <span>{{scope.row.skill.yellow}}</span>
				</template> </el-table-column>
